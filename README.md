...
**Signing key fingerprint:** `8A55 9E3B B6EB 0640 1622 73BC C1D6 43CE B30C 6C59`. Do not trust a key whose fingerprint does not match this value. Releases up to and including `v0.1.1` are unsigned and cannot be installed through this repository.
